...
import com.rdyang.hibernate.dao.BaseDaoCopy;
import com.rdyang.hibernate.dao.HibernateHandler;
import com.rdyang.hibernate.util.ObjectUtil;
import com.rdyang.hibernate.util.PaginationCopy;  
  
@Repository
@Lazy(true)
public class BaseDaoImplCopy<T> implements BaseDaoCopy<T> {
	 ...
	 protected Class<T> entityClazz;  
	    ...
	    @SuppressWarnings({ "unchecked", "hiding" })  
	    public <T> PaginationCopy<T> findPagination(CharSequence queryString, int pageIndex, int pageSize, Object... params) {  
	        Query query = getSession().createQuery(queryString.toString());  
	        ...
	        @SuppressWarnings("rawtypes")  
	        PaginationCopy pagination = new PaginationCopy(pageIndex, pageSize, rowsCount);  
	    ...
	    @Override
	    @SuppressWarnings({ "unchecked" })  
	    public PaginationCopy<T> findPagination(CharSequence queryString, Map<String, Object> params, int pageIndex,  
	            int pageSize) {  
	        Query query = getSession().createQuery(queryString.toString());  
	    ...
	    @Override
	    @SuppressWarnings({ "unchecked", "hiding" })  
	    public <T> PaginationCopy<T> findPagination(CharSequence queryString, CharSequence countString, int pageIndex,  
	    ...
	    @Override
	    @SuppressWarnings({ "unchecked", "hiding" })  
	    public <T> PaginationCopy<T> findPagination(CharSequence queryString, CharSequence countString,  
	    ...
	    public <T> PaginationCopy<T> findSqlPagination(CharSequence queryString, final CharSequence countString,  
	        ...
	        @SuppressWarnings("rawtypes")  
	        PaginationCopy pagination = new PaginationCopy(pageIndex, pageSize, rowsCount.intValue());  
	        pagination.setItems(items);  
	        return pagination;  
	    }  
	    ...
	    public class DmlHelper {  
	        ...
	        public <D> PaginationCopy<D> findPagin(int pageIndex, int pageSize) {  
