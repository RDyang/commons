...
public interface BaseDaoCopy<T> {
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> PaginationCopy<T> findPagination(CharSequence queryString, int pageIndex, int pageSize, Object... params);
	 ...
	 * @return 实体分页对象
	 */
	PaginationCopy<T> findPagination(CharSequence queryString, Map<String, Object> params, int pageIndex, int pageSize);
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> PaginationCopy<T> findPagination(CharSequence queryString, CharSequence countString, int pageIndex, int pageSize,
			Object... params);
	 ...
	 */
	@SuppressWarnings("hiding")
	<T> PaginationCopy<T> findPagination(CharSequence queryString, CharSequence countString, Map<String, Object> params,
	 ...
	 */
	@SuppressWarnings("hiding")
	public <T> PaginationCopy<T> findSqlPagination(final CharSequence queryString, final CharSequence countString,
