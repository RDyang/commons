...
public class ObjectUtil {  
    ...
    public static <T, S> PaginationCopy<T> makePagination(PaginationCopy<S> src, Class<T> targetClzz) {  
        if (src == null)  
            return null;  
  
        PaginationCopy<T> result = new PaginationCopy<T>(src.getCurIndex(), src.getPageSize(), src.getRowsCount());  
