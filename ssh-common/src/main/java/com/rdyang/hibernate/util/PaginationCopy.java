...
public class PaginationCopy<T> implements Serializable {  
     ...
     *            每页记录数  
     */  
    public PaginationCopy(long pageIndex, long pageSize) {  
     ...
     *            记录总数  
     */  
    public PaginationCopy(long pageIndex, long pageSize, long rowsCount) {  
